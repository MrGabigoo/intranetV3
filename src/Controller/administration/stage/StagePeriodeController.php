...
/**
 * @Route({"fr":"administration/stage/periode",
 *         "en":"administration/stage/period"})
 */
class StagePeriodeController extends BaseController
{
    ...
    /**
     * @Route("/export.{_format}", name="administration_stage_periode_export", methods="GET", requirements={"_format"="csv|xlsx|pdf"})
    ...
    {
        $stagePeriode = new StagePeriode($this->dataUserSession->getAnneeUniversitaire());
