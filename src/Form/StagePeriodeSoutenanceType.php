...
class StagePeriodeSoutenanceType extends AbstractType
{
    ...
    {
        $builder
            ->add('dateRange', DateRangeType::class, ['label' => 'dateRange.soutenance', 'mapped' => false, 'required' => true])
            ...
            ->addEventListener(            FormEvents::PRE_SET_DATA, function (FormEvent $event) {
                $stagePeriodeSoutenance = $event->getData();
                $form = $event->getForm();
                $form->add('dateRange', DateRangeType::class, ['label' => 'dateRange.soutenance', 'mapped' => false, 'date_data' => ['from' => $stagePeriodeSoutenance->getDateDebut(), 'to' => $stagePeriodeSoutenance->getDateFin()]]);
            });
    }
